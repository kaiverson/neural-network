...
Matrix *matrix_zero(Matrix *matrix);    /* Changes all of the values of a matrix to zero. */
...
LayerDense *nn_layer_dense_init(int size_input, int size_output);    /* Creates a dense nn layer and fills it with randn parameters. */
